...
[System.Serializable]
public class BeamsIII : EntitySystem
{

    [field: SerializeField] public override string SystemName { get; set; } = "BeamsIII";
    ...
    void Start()
    {
        ...
        if (this.gameObject.TryGetComponent<EntityAI>( out EntityAI PAI))
        {
            ...
            {
                BulletType = ParentAI.OffensiveSystemData.SpawnableObjects.Where(gameObject => gameObject.name == "BeamsIII").SingleOrDefault();
            }
            else
            {
