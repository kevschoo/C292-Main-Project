...
[System.Serializable]
public class BeamsII : EntitySystem
{

    [field: SerializeField] public override string SystemName { get; set; } = "BeamsII";
    ...
    void Start()
    {
        ...
        if (this.gameObject.TryGetComponent<EntityAI>( out EntityAI PAI))
        {
            ...
            {
                BulletType = ParentAI.OffensiveSystemData.SpawnableObjects.Where(gameObject => gameObject.name == "BeamsII").SingleOrDefault();
            }
            else
            {
